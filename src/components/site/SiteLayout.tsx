  ...
  return (
    <section className="relative overflow-hidden pt-36 pb-16 md:pt-44 md:pb-24">
      ...
      <div className="mx-auto max-w-4xl px-5 text-center">
        ...
        <h1 className="mt-5 font-display text-[clamp(2.25rem,5vw,4rem)] leading-[1.05] text-[var(--plum-deep)] text-balance">
          {title}
        </h1>
        {description ? (
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[var(--ink)]/70">{description}</p>
        ) : null}
